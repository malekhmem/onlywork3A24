 ...
 * @author chaker
 */
public class ModifierPasswordPrestatairefxmlController implements Initializable {
    ...
    private void ValiderChangement(ActionEvent event) {
     ...
     public void changerPass(){
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/GUI/Prestatairefxml.fxml"));
