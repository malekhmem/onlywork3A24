...
public class FournisseurfxmlController implements Initializable {
    ...
    @FXML
    private void goToChangePass(ActionEvent event) {
         try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/GUI/ModifierPasswordFournisseurFXML.fxml"));
            Parent root = loader.load();
            numTexte.getScene().setRoot(root);
